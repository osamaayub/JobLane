    ...
    <>
      ...
      <div className='bg-gray-900 min-h-screen pt-14 md:px-20 px-3 text-white'>
        ...
        <div className="pt-1 fixed left-0 z-20 pl-0">
          <div onClick={(() => setSideTog(!sideTog))} className='cursor-pointer bg-blue-600 hover:bg-blue-700 transition-colors duration-300 px-3 py-2 rounded-md' size={44}>
        ...
        <div className='w-full'>
          {loading ? (
            ...
            <>
              ...
              <div className='grid md:grid-cols-3 grid-cols-1 gap-16 md:pt-28 pt-16 pb-28'>
                <div className='flex flex-col gap-3 justify-center items-center bg-gray-800 p-6 rounded-lg shadow-lg'>
