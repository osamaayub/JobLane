...
const Navbar = () => {
    ...
    return (
        <div className='text-white min-w-full overflow-x-hidden z-20 bg-gray-800 border-b border-gray-700'>
            {/* Desktop Navbar */}
                        {!isMobile && (
                            <ul className='hidden lg:flex justify-between items-center py-3 font-semibold text-xl px-10'>
                                <div className='flex items-center gap-24'>
                                    <Link to="/" className='flex justify-center items-center titleTitle'>
